...
var pageNav="<div class='pull-right padlr5 clearfix' style='float:right;'><ul class='simplePagerNav pagination paganation-box'>";for(i=1;i<=pageCounter;i++){if(i==options.currentPage){pageNav+="<li class='currentPage simplePageNav"+i+"'><a rel='"+i+"' href='#'>"+i+"</a></li>";}
