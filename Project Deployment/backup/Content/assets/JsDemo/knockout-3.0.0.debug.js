        ...
        isIe7 = ieVersion === 7;
            ...
            ko.utils.arrayForEach(["pop", "push", "reverse", "shift", "sort", "splice", "unshift"], function (methodName) {
                ko.observableArray['fn'][methodName] = function () {
                    ...
                    //                    console.log(underlyingArray[0].EmployeeName());
                    //                    console.log(underlyingArray[1].EmployeeName());

                    //                    console.log(methodCallResult[0].EmployeeName());
                    //                    console.log(methodCallResult[1].EmployeeName());
                    this.valueHasMutated();
